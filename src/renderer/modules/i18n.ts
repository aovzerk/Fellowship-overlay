(() => {
  const I18N: Record<LanguageCode, Record<string, string>> = {
    ...
    ru: {
      ...
      partyFrameAlignment: 'Выравнивание карточки группы',
      partyFrameGrowthDirection: 'Рост карточки группы',
      alignmentLeft: 'Слева',
      alignmentCenter: 'По центру',
      alignmentRight: 'Справа',
      ...
      partyFrameFieldsTitle: 'Поля карточки группы',
      partyFieldPlayerName: 'Имя игрока',
      partyFieldChampionName: 'Имя чемпиона',
      partyFieldSpirit: 'Spirit',
      partyFieldRelics: 'Реликвии и кулдауны',
      menuColorsTitle: 'Цвета меню',
      menuColorText: 'Основной текст',
      menuColorTitle: 'Заголовки',
      menuColorMutedText: 'Вторичный текст',
      menuColorPanelBackground: 'Фон окон меню',
      menuColorSectionBackground: 'Фон блоков',
      menuColorControlBackground: 'Фон кнопок и полей',
      menuColorBorder: 'Границы',
      menuColorAccent: 'Акцент',
    ...
    en: {
      ...
      partyFrameAlignment: 'Party frame alignment',
      partyFrameGrowthDirection: 'Party frame growth',
      alignmentLeft: 'Left',
      ...
      partyFrameFieldsTitle: 'Party frame fields',
      partyFieldPlayerName: 'Player name',
      partyFieldChampionName: 'Champion name',
      partyFieldSpirit: 'Spirit',
      partyFieldRelics: 'Relics and cooldowns',
      menuColorsTitle: 'Menu colors',
      menuColorText: 'Text color',
      menuColorTitle: 'Title color',
      menuColorMutedText: 'Muted text color',
      menuColorPanelBackground: 'Menu window background',
      menuColorSectionBackground: 'Section background',
      menuColorControlBackground: 'Button and field background',
      menuColorBorder: 'Border color',
      menuColorAccent: 'Accent color',
